...
const paramSchema = require('../../../params/providers/volcengine/video/query-video-generation-task')

/**
 * 火山引擎查询视频生成任务API类
 */
class QueryVideoGenerationTask extends BaseAPI {
  /**
   * 创建火山引擎查询视频生成任务API实例
...
module.exports = QueryVideoGenerationTask
