...
const paramSchema = require('../../../params/providers/volcengine/3d/query-3d-generation-task')

/**
 * 火山引擎查询3D生成任务API类
 */
class Query3DGenerationTask extends BaseAPI {
  /**
   * 创建火山引擎查询3D生成任务API实例
...
module.exports = Query3DGenerationTask
