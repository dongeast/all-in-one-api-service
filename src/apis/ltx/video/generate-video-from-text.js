/**
 * Generate Video from Text API
 */

const BaseAPI = require('../../base-api')
const paramSchema = require('../../../params/providers/ltx/video/generate-video-from-text')

/**
 * Generate Video from Text API类
 */
class GenerateVideoFromText extends BaseAPI {
  /**
   * 创建Generate Video from Text API实例
   * @param {object} service - LTX服务实例
   */
  constructor(service) {
    super(service, paramSchema)
    this.modelName = 'generate_video_from_text_task'
    this.endpoint = '/v1/text-to-video'
  }
