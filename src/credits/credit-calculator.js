...
class CreditCalculator {
   ...
   */
  calculateActualCredits(provider, apiName, params, result) {
    try {
      const estimated = this.calculateEstimatedCredits(provider, apiName, params)
      ...
      if (result && result.metadata) {
        ...
        if (actualDuration && actualDuration !== params.duration) {
          ...
          const adjusted = this.calculateEstimatedCredits(provider, apiName, adjustedParams)
